...
- (void)drawAnimated:(BOOL)animated{
    ...
    CALayer* line = [BaseLayer layerOfLineFrom:CGPointZero to:CGPointMake(width+2, 0) withColor:[BBTheme defTheme].axisColor andWidth:1];
...
//            NSLog(@"Draw x: %d", i);
            CATextLayer* label = [BaseLayer layerOfText:text withFont:@"HelveticaNeue" fontSize:[BBTheme defTheme].xAxisFontSize andColor:[BBTheme defTheme].axisColor];
            CGFloat w = [BBChartUtils textBoundsForFont:text andSize:[BBTheme defTheme].xAxisFontSize text:text].width;
            ...
            CALayer* dash = [BaseLayer layerOfLineFrom:CGPointMake(idxWidth/2, 0) to:CGPointMake(idxWidth/2, 5) withColor:[BBTheme defTheme].axisColor andWidth:1];
